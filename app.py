...
<h2 style="color:white;text-align:center;font-size:35px"><b>Phone Features</b></h2>
</div>
<br>
<br>
"""
...
if st.checkbox("Tentang Dataset"):
    html_layout2 ="""
    <br>
    <p>Dataset "Price Range Phone" adalah kumpulan data yang berisi informasi tentang berbagai fitur dan atribut dari telepon seluler (mobile phone). Setiap entri dalam dataset mewakili satu model telepon seluler dan mencakup berbagai spesifikasi teknis yang dapat memengaruhi harga jualnya. Dataset ini dapat digunakan untuk memahami korelasi antara fitur-fitur tertentu dari ponsel dengan rentang harga yang mereka miliki di pasar. </p>
    """
...
if st.checkbox('Distribusi Harga'):
    ...
    st.sidebar.pyplot(price_distribution_fig)
